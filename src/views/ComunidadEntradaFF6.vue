    ...
    <ion-page>
      ...
      <ion-content :fullscreen="true" class="gradient-background">
        <div class="game-container">
          <div class="game-card">
            <h1 class="game-title">Final Fantasy VI</h1>
            
            <div class="game-description">
              <p>
                Final Fantasy VI, es un videojuego de rol desarrollado 
                y publicado por Squaresoft como la sexta entrega de la 
                saga Final Fantasy.
              </p>
            </div>
