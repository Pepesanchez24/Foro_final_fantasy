    ...
    <ion-page>
      ...
      <ion-content :fullscreen="true" class="gradient-background">
        <div class="game-container">
          <div class="game-card">
            <h1 class="game-title">Final Fantasy III</h1>
            
            <div class="game-description">
              <p>
                Final Fantasy III es un videojuego de rol desarrollado 
                y publicado por Square en 1990 que forma parte de la serie 
                de videojuegos Final Fantasy.
              </p>
            </div>
