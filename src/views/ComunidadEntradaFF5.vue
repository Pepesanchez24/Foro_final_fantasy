    ...
    <ion-page>
      ...
      <ion-content :fullscreen="true" class="gradient-background">
        <div class="game-container">
          <div class="game-card">
            <h1 class="game-title">Final Fantasy V</h1>
            
            <div class="game-description">
              <p>
                Final Fantasy V es un videojuego de rol desarrollado y 
                publicado por Squaresoft en 1992 que forma parte de la 
                serie de videojuegos Final Fantasy. El juego salió solo 
                en Japón para la Super Famicom, y fue portado por TOSE 
                con pequeñas diferencias para Sony PlayStation y la 
