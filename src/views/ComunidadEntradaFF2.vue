    ...
    <ion-page>
      ...
      <ion-content :fullscreen="true" class="gradient-background">
        <div class="game-container">
          <div class="game-card">
            <h1 class="game-title">Final Fantasy II</h1>
            
            <div class="game-description">
              <p>
                Final Fantasy II es la segunda entrega de la saga 
                de videojuegos Final Fantasy, de la empresa Squaresoft, 
                ahora conocida como Square-Enix. No hay que confundirlo 
                con Final Fantasy IV, que en Estados Unidos apareció como FFII 
