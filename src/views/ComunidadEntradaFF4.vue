    ...
    <ion-page>
      ...
      <ion-content :fullscreen="true" class="gradient-background">
        <div class="game-container">
          <div class="game-card">
            <h1 class="game-title">Final Fantasy IV</h1>
            
            <div class="game-description">
              <p>
                Final Fantasy IV es un videojuego desarrollado y hecho 
                por Squaresoft en 1991 formando parte de la serie de videojuegos 
                Final Fantasy. Fue el primero de la saga que salió para la 
                consola SNES. En ella se eliminó la elección de oficios que 
                había aparecido en la tercera parte y los personajes tienen 
                nombres de antemano.
              </p>
            </div>
